...
@hydra.main(
    version_base=None,
    config_path="/home/wxy/wxy_workspace/LLM_unlearn/tofu-main/config",
    config_name="aggregate_eval_stat",
)
def main(cfg):
    root_dir = "/home/wxy/wxy_workspace/LLM_unlearn/tofu-main"
    # TODO:
    retain_file_name = "ft_epoch5_lr2e-05_phi_retain99_wd0.01"
    unlearn_dir_name = "tofu_idk_result"
    unlearn_file_name = "edit_1e-05_forget01_1_wd0.01_bs40"  # "locuslab_tofu_ft_phi/forget05_perturbed"

    cfg.method_name = "edit"  # grad_ascent, grad_diff, idk, dpo
    cfg.task = "forget01"

    cfg.retain_result = f"{root_dir}/data/{retain_file_name}/eval_results/ds_size300/eval_log_aggregated.json"
    cfg.ckpt_result = (
        f"{root_dir}/{unlearn_dir_name}/{unlearn_file_name}/eval_results/ds_size300/eval_log_aggregated.json"
    )
    cfg.save_file = f"{root_dir}/{unlearn_dir_name}/{unlearn_file_name}/aggr_result.csv"
