...
@hydra.main(
    version_base=None,
    config_path="/home/wxy/wxy_workspace/LLM_unlearn/tofu-main/config/finetune",
    config_name="finetune_phi",
)
def main(cfg):
    ...
    model_cfg = get_model_identifiers_from_yaml(cfg.model_family)  # 从model_config.yaml中读取模型设置
